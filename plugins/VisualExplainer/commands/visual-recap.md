...
Create an interactive VisualExplainer recap for work that already exists. This is the reverse of `/generate-visual-plan`: it explains what changed instead of planning what should change.
