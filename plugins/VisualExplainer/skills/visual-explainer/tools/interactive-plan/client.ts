...
(() => {
  ...
  document.addEventListener("click", (event) => {
    ...
    if (target.closest("[data-expand]")) {
      ...
      popup?.document.write("<!doctype html><title>VisualExplainer diagram</title><body style='margin:0;background:#101418;display:grid;place-items:center;min-height:100vh;padding:32px'>" + svg + "</body>");
