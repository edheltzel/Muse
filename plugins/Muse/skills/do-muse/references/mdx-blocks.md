...
All interactive plan components compile to Muse block data with stable IDs. Every component must include an `id` prop so comments, answers, and approval state can anchor to it.
