...
Activate by asking Codex to use `$Muse` or the `Muse` skill before generating diagrams, diff reviews, plan reviews, slide decks, or complex tables. Generated pages go to `.agents/diagrams/`; opening the browser may depend on Codex sandbox permissions.
